...
@ stdcall wine_vkGetPhysicalDeviceExternalBufferProperties(ptr ptr ptr)
@ stdcall wine_vkGetPhysicalDeviceExternalFenceProperties(ptr ptr ptr)
@ stdcall wine_vkGetPhysicalDeviceExternalSemaphoreProperties(ptr ptr ptr)
